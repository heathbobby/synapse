...
| ADR-0011 | accepted | MVP1 delivery mode is CLI-assisted orchestration using the existing framework. | The sponsor selected CLI-assisted delivery for MVP1. This keeps MVP1 executable through `orchestration-framework/cli.py`, task cards, memos, and committed docs without committing to a full Synapse runtime implementation yet. | Sponsor decision 2026-05-03; `docs/work_items/INDEX.md`; `docs/planning/EXECUTION_ORCHESTRATION.md` | 2026-05-03 |
| ADR-0012 | accepted | Use the orchestration framework itself as the first MVP1 domain/initiative. | The sponsor selected the orchestration framework as the first domain. This provides an internal, source-backed initiative for workflow/task-packet refinement without inventing an external customer scenario. | Sponsor decision 2026-05-03; `docs/work_items/DEPENDENCY_MAP.md` | 2026-05-03 |
...
| --- | --- | --- | --- | --- |
| OAD-0001 | MVP scope after CLI-assisted foundation | Component depth, adapter priorities, and approval policies beyond MVP1 depend on later target workflows. | MVP1 uses CLI-assisted orchestration and the orchestration framework as the first internal domain; keep later product/runtime scope domain-agnostic until additional workflows are validated. | ADR-0011; ADR-0012; `work_items/synapse-product-brief.md` |
